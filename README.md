...
**[Открыть в браузере →](https://bogggare567.github.io/yakushin/)** — ничего скачивать не нужно; файл, как и всегда, остаётся на вашем устройстве. Связь с телефоном работает только при запуске у себя (см. ниже), потому что держится на локальном сервере.
...
- **С телефона или планшета, без компьютера рядом** — открыть [bogggare567.github.io/yakushin](https://bogggare567.github.io/yakushin/). Разбор пойдёт прямо на телефоне: медленнее, чем на ноутбуке, и без синхронизации, но всё остальное работает.
